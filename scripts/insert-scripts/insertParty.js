...
<div class="collapsible-content" style="display:none;">
    <div id="flex-container-party-buff">
        ...
        <div class="flex-container-party-buff-inner">
            <div class="flex-container-party-buff-inner2">
                <abbr title="編成時、妖怪の攻撃力+12%" style="cursor: help;"><img src="../../img/chara-icons/icon_10317_0_s.png" class="party-buff-img"></abbr>
                <span class="party-buff-name">初縁ココノハ</span>
            </div>
            <div class="flex-container-party-buff-inner2">
                <span class="party-buff-label">編成</span>
        ...
        <div class="flex-container-party-buff-inner">
            <div class="flex-container-party-buff-inner2">
                <abbr title="編成時、味方のエイリアン/闇属性モンスター娘それぞれの攻撃力+8%(完凸で+2%)" style="cursor: help;"><img src="../../img/chara-icons/icon_10338_0_s.png" class="party-buff-img"></abbr>
                <span class="party-buff-name">プピペルザ</span>
            </div>
            <div class="flex-container-party-buff-inner2">
                <span class="party-buff-label">編成</span>
                <input type="checkbox" id="party10338" class="larger-check party-check" onchange="allDPS();">
                <span class="party-buff-label">完凸</span>
                <input type="checkbox" id="awake10338" class="larger-check party-check" onchange="allDPS();">
            </div>
        </div>
        <div class="flex-container-party-buff-inner">
            <div class="flex-container-party-buff-inner2">
                <abbr title="編成時、味方のエイリアン/光属性モンスター娘それぞれの攻撃力+8%(完凸で+2%)" style="cursor: help;"><img src="../../img/chara-icons/icon_10341_0_s.png" class="party-buff-img"></abbr>
                <span class="party-buff-name">ピエンティア</span>
            </div>
            <div class="flex-container-party-buff-inner2">
                <span class="party-buff-label">編成</span>
                <input type="checkbox" id="party10341" class="larger-check party-check" onchange="allDPS();">
                <span class="party-buff-label">完凸</span>
                <input type="checkbox" id="awake10341" class="larger-check party-check" onchange="allDPS();">
            </div>
        </div>
        <div class="flex-container-party-buff-inner">
            <div class="flex-container-party-buff-inner2">
                <abbr title="編成時、味方の竜特性/光属性モンスター娘それぞれの攻撃力+8%(完凸で+2%)" style="cursor: help;"><img src="../../img/chara-icons/icon_10348_0_s.png" class="party-buff-img"></abbr>
                <span class="party-buff-name">宝石竜ルルゥ</span>
            </div>
            <div class="flex-container-party-buff-inner2">
                <span class="party-buff-label">編成</span>
                <input type="checkbox" id="party10348" class="larger-check party-check" onchange="allDPS();">
                <span class="party-buff-label">完凸</span>
                <input type="checkbox" id="awake10348" class="larger-check party-check" onchange="allDPS();">
            </div>
        </div>
    </div>
