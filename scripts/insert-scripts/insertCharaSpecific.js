...
<div class="collapsible-content" style="display:block;">
    <div id="flex-container-charaSpecific-buff">
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10056">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10056_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">物防アップ(専)</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">スキル発動回数</span>
                <input id="charaSpecific10056-2" class="" type="number" min="0" max="3" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="selfReferenceChange('102',this.value);allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10255">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10255_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">攻撃力アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">攻撃回数(10秒)</span>
                <input id="charaSpecific10255-1" class="" type="number" min="0" max="180" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10268">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10268_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">CRIダメアップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">クリティカル回数</span>
                <input id="charaSpecific10268-1" class="" type="number" min="0" max="20" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10275">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10275_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">攻撃アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10280">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10280_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">攻撃アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">吸収した敵の攻撃力</span>
                <input id="charaSpecific10280-1" class="" type="number" min="0" max="99999" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10287">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10287_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">回復量アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">水属性の味方</span>
                <input id="charaSpecific10287-1" type="checkbox" class="larger-check charaSpecific-check" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10288">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10288_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">HPアップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">受けたダメージ</span>
                <input id="charaSpecific10288-1" class="" type="number" min="0" max="20000" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="selfReferenceChange('102',this.value);allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10302">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10302_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">攻撃アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">倒した敵</span>
                <input id="charaSpecific10302-1" class="" type="number" min="0" max="10" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10316">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10316_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">スキルCD</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">倒した敵</span>
                <input id="charaSpecific10316-1" class="" type="number" min="0" max="45" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10322">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10322_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">攻撃アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">倒した敵</span>
                <input id="charaSpecific10322-1" class="" type="number" min="0" max="10" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10334">
            <div class="flex-container-charaSpecific-buff-inner2">
                ...
                <span class="charaSpecific-buff-name">攻撃+CRI率</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">バトル中トークン数</span>
                <input id="charaSpecific10334-1" class="" type="number" min="0" max="180" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="selfConditionChange('2006',Number(this.value));allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10337">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10337_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">攻撃力アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">復活した回数</span>
                <input id="charaSpecific10337-1" class="" type="number" min="0" max="1" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="selfConditionChange('2006',Number(this.value));allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10356">
            ...
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">倒した敵</span>
                <input id="charaSpecific10356-1" class="" type="number" min="0" max="20" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10357">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10357_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">攻速アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10369">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10369_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">アラン</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">待機中時間(秒)</span>
                <input id="charaSpecific10369-1" class="" type="number" min="0" max="60" value="0" style="width:70%;height:20%;margin:2px auto;border:none;" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        <div class="flex-container-charaSpecific-buff-inner chara-specific-10370">
            <div class="flex-container-charaSpecific-buff-inner2">
                <img src="../../img/chara-icons/icon_10370_0_s.png" class="charaSpecific-buff-img">
                <span class="charaSpecific-buff-name">回復量アップ</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">味方配置マスが火属性</span>
                <input id="charaSpecific10370-1" type="checkbox" class="larger-check charaSpecific-check" onchange="allDPS();">
                <span class="charaSpecific-buff-label"></span>
            </div>
        </div>
        ...
        <div class="flex-container-charaSpecific-buff-inner chara-specific-16021">
            <div class="flex-container-charaSpecific-buff-inner2">
                ...
                <span class="charaSpecific-buff-name">扇CC4以上</span>
            </div>
            <div class="flex-container-charaSpecific-buff-inner2" style="flex:2;">
                <span class="charaSpecific-buff-label"></span>
                <span class="charaSpecific-buff-label">移動回数(10秒)</span>
