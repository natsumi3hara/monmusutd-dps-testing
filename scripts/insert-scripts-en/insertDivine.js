...
<button type="button" class="collapsible-button inputInsertButton">Divine Beasts（Click to expand）</button>
    ...
    <div id="flex-container-divine-buff">
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">None</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
                <input type="checkbox" id="divine30000" class="larger-check divine-check" checked onChange="divineOneOnly('divine30000');allDPS();">
                <span class="divine-buff-label">Passive Lv</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Vivi</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Nidhogg</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Pazuzu</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Faro</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Behemoth</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Solais</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Bikkinu</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Maid Vivi</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
        ...
        <div class="flex-container-divine-buff-inner">
            <div class="flex-container-divine-buff-inner2">
                ...
                <span class="divine-buff-name">Sera</span>
            </div>
            <div class="flex-container-divine-buff-inner2">
                <span class="divine-buff-label">Party</span>
